...
Download the [KerbMinder install package](https://dl.dropboxusercontent.com/u/3967964/KerbMinder.v1.0rc1.pkg.zip) and run it. No reboot or logout is necessary, but admin privileges are required.
